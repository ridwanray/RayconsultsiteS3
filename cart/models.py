...
from shop.models import Productname
...
class CartItem(models.Model):
	...
	item = models.ForeignKey(Variation, on_delete=models.CASCADE,null=True, blank=True,)
	itemcategory = models.ForeignKey(Category, on_delete=models.CASCADE,null=True, blank=True,)
	productnamereal = models.ForeignKey(Productname, on_delete=models.CASCADE, null=True, blank=True)
